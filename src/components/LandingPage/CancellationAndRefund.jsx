  ...
  return (
    <div className="max-w-5xl mx-auto p-8 text-gray-800 bg-gray-50">
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li>You may cancel your subscription at any time via your account dashboard or by emailing <a href="mailto:apiconnect201@gmail.com" className="text-blue-600 underline hover:text-blue-800">apiconnect201@gmail.com</a>.</li>
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li>Refunds are evaluated on a case-by-case basis. If you are unsatisfied within 7 days of subscribing, contact us at <a href="mailto:apiconnect201@gmail.com" className="text-blue-600 underline hover:text-blue-800">apiconnect201@gmail.com</a> for a potential refund.</li>
